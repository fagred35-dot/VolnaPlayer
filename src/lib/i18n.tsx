...
const en = {
  ...
  syncMyIp: "My IP",
  syncToggle: "Device sync",
  syncToggleHint: "Off by default — the PC listens on the local network only while enabled",
  syncServerDisabled: "Sync is off — turn it on to connect devices",
  syncCodeLabel: "Pair code — enter it on the other device",
  syncCodeCopy: "Copy",
  syncCodeCopied: "Copied",
  syncCodeAsk: "Enter the pair code shown on the PC screen (12 characters):",
  syncCodePlaceholder: "Pair code",
  syncErrBadCode: "Wrong pair code — check the number on the PC screen",
...
const ru: Record<TKey, string> = {
  ...
  syncMyIp: "Мой IP",
  syncToggle: "Синхронизация устройств",
  syncToggleHint: "Выключено по умолчанию — ПК слушает локальную сеть только когда включено",
  syncServerDisabled: "Синхронизация выключена — включите, чтобы подключать устройства",
  syncCodeLabel: "Парный код — введите его на другом устройстве",
  syncCodeCopy: "Копировать",
  syncCodeCopied: "Скопировано",
  syncCodeAsk: "Введите парный код с экрана ПК (12 символов):",
  syncCodePlaceholder: "Код",
  syncErrBadCode: "Неверный парный код — сверьте число на экране ПК",
